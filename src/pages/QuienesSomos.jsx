...
export default function QuienesSomos() {
  return (
    <div className="min-h-screen px-4 py-12  bg-cover bg-center bg-no-repeat bg-fixed relativ" style={{ backgroundImage: 'url(/logos/fondo.png)' }}>
      ...
      <div className="max-w-3xl mx-auto p-4 relative z-10 bg-white bg-opacity-10 rounded-lg shadow-lg">
        <div className="">
          <img
          ...
          <h2 className="text-xl font-bold text-black mt-6 mb-2">Nuestra misión</h2>
          <p className="text-black text-lg mb-4 leading-relaxed">
          ...
          <h2 className="text-xl font-bold text-black mt-6 mb-2">Cómo funciona</h2>
          <ul className="text-black text-lg space-y-2 list-disc list-inside">
