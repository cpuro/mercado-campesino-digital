    ...
    <div>
      ...
      <div className="mb-6 w-full max-w-sm min-w-[200px] mx-auto">
        <div className="relative">
          ...
          <button
            type="button"
            className="absolute top-1 right-1 flex items-center rounded bg-green-500 py-1 px-2.5 border border-transparent text-center text-sm text-white transition-all shadow-sm hover:shadow focus:bg-slate-700 focus:shadow-none active:bg-slate-700 hover:bg-slate-700 active:shadow-none"
          >
            ...
            >
              ...
              <div className="px-4 pb-4 pt-0 mt-auto">
                <button
                  ...
                  className="w-full rounded-md bg-green-600 py-2 px-4 text-center text-sm font-semibold text-white transition-all shadow-md hover:bg-green-700 hover:shadow-lg active:shadow-none"
                >
